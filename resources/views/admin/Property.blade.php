...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><strong style="font-size: 27px;">التقييمات</strong>  </h1>
            </div>
            <div style="font-size: 17px;" class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                     <li class="breadcrumb-item"><a href="{{ url('/admin/AdminDashboard')}}">الرئيسية</a></li>
                    <li class="breadcrumb-item active"><a href="{{ url('/admin/propertiesRate')}}"> التحكم في التقييمات </a></li>
                </ol>
             </div>
